...
- Create Angular project with ng: `ng new angularmvccore.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularmvccore.client.esproj`).
